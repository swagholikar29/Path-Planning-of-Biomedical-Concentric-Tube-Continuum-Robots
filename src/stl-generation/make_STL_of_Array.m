...
%======================================================
tic
f = waitbar(0,'STL generation in progress...');
    for i3 = 1 : size(Data,3)
        ...
        toc
        waitbar(i3/size(Data,3),f,'STL generation in progress...');
    end
    ...
    % WRITE THE STL FILE
save('FileName','Triangle','Vertices')
stlwrites(FileName, Triangle, Vertices);
